  ...
  series: [
    {
      ...
      dataLabels: {
        format:
          '<div style="text-align:center"><span style="font-size:32px;color:' +
...
function Analysis() {
  ...
  useEffect(() => {
    ...
    Highcharts.chart(
      ...
      showMonthlyGraph ? optionsCoinPlusByMonth : optionsTransactionPlusByMonth
    );
    Highcharts.chart(
      "Coin-minus-graph-container",
      showMonthlyGraph
        ? optionsCoinMinusByMonth
