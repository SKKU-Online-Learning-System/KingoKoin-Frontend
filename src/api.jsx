...
export const fetchgetStaticsByMonth = async () => {
...
export const fetchgetStaticsByDay = async () => {
...
export const fetchgetStaticsPlusByMonth = async () => {
...
export const fetchgetStaticsMinusByMonth = async () => {
